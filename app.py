...
DATABASE = os.path.join(DATABASE_DIR, "farmerqueue.db")

app = Flask(__name__)
app.secret_key = os.environ.get("SECRET_KEY", "farmerqueue-dev-secret-key")
...
# Initialize the database when the module is loaded by Gunicorn/Render.
init_db()
